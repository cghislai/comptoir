...
var ProtoViewBuilder = (function () {
    ...
    ProtoViewBuilder.prototype.build = function () {
        ...
        return new api.ProtoViewDto({
            render: new proto_view_1.DomProtoViewRef(proto_view_1.DomProtoView.create(this.type, this.rootElement, this.viewEncapsulation, [rootNodeCount], rootTextNodeIndices, domElementBinders, this.hostAttributes)),
            type: this.type,
...
function createElementPropertyBinding(ast, propertyNameInTemplate) {
    ...
    if (parts.length === 1) {
        ...
        return new api.ElementPropertyBinding(api.PropertyBindingType.CLASS, ast, util_1.camelCaseToDashCase(parts[1]));
    }
