...
import { isListLikeIterable, iterateListLike, MapWrapper } from 'angular2/src/facade/collection';
import { isBlank, isPresent, stringify, getMapKey, looseIdentical, isArray } from 'angular2/src/facade/lang';
import { WrappedValue, BasePipe } from './pipe';
export let IterableChangesFactory = class {
...
export class IterableChanges extends BasePipe {
    ...
    transform(collection, args = null) {
