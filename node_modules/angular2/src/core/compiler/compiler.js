...
var Compiler = (function () {
    ...
    Compiler.prototype.compileInHost = function (componentTypeOrBinding) {
        ...
        return hostPvPromise.then(function (hostAppProtoView) { return hostAppProtoView.ref; });
    };
    Compiler.prototype._compile = function (componentBinding, componentPath) {
        ...
        resultPromise =
            this._render.compile(renderTemplate)
                ...
                var protoViews = _this._protoViewFactory.createAppProtoViews(componentBinding, renderPv, boundDirectives);
