...
export declare class NumberPipe extends BasePipe implements PipeFactory {
 ...
 */
export declare class DecimalPipe extends NumberPipe {
 ...
 */
export declare class PercentPipe extends NumberPipe {
    transform(value: any, args: any[]): string;
}
/**
 ...
 * For more information about `digitInfo` see {@link DecimalPipe}
 */
export declare class CurrencyPipe extends NumberPipe {
    transform(value: any, args: any[]): string;
}
