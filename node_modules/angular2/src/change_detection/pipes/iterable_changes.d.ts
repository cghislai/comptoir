...
export declare class IterableChangesFactory implements PipeFactory {
    supports(obj: any): boolean;
    create(cdRef: ChangeDetectorRef): Pipe;
}
export declare class IterableChanges extends BasePipe {
    private _collection;
    private _length;
    ...
    constructor();
    static supportsObj(obj: Object): boolean;
    ...
    transform(collection: any, args?: List<any>): any;
