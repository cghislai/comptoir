...
import { EmptyExpr, ImplicitReceiver, AccessMember, SafeAccessMember, LiteralPrimitive, Binary, PrefixNot, Conditional, If, BindingPipe, Assignment, Chain, KeyedAccess, LiteralArray, LiteralMap, Interpolation, MethodCall, SafeMethodCall, FunctionCall, TemplateBinding, ASTWithSource } from './ast';
var _implicitReceiver = new ImplicitReceiver();
// TODO(tbosch): Cannot make this const/final right now because of the transpiler...
var INTERPOLATION_REGEXP = /\{\{(.*?)\}\}/g;
export let Parser = class {
    constructor(_lexer, providedReflector = null) {
        this._lexer = _lexer;
...
class SimpleExpressionChecker {
    ...
    visitSafeAccessMember(ast) { this.simple = false; }
    ...
    visitKeyedAccess(ast) { this.simple = false; }
    visitAll(asts) {
    ...
    visitAssignment(ast) { this.simple = false; }
