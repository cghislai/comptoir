...
var Parse5DomAdapter = (function (_super) {
    ...
    Parse5DomAdapter.prototype.logGroup = function (error) { console.log(error); };
    ...
    Parse5DomAdapter.prototype.createTextNode = function (text) { throw _notImplemented('createTextNode'); };
    ...
    Parse5DomAdapter.prototype.isPageRule = function (rule) {
        return rule.type === 6; // CSSRule.PAGE_RULE
    };
    Parse5DomAdapter.prototype.isStyleRule = function (rule) {
        return rule.type === 1; // CSSRule.MEDIA_RULE
    };
    Parse5DomAdapter.prototype.isMediaRule = function (rule) {
        return rule.type === 4; // CSSRule.MEDIA_RULE
    };
    Parse5DomAdapter.prototype.isKeyframesRule = function (rule) {
    ...
    Parse5DomAdapter.prototype.cssToRules = function (css) {
    ...
    Parse5DomAdapter.prototype.setGlobalVar = function (name, value) { lang_1.global[name] = value; };
