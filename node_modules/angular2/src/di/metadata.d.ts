 ...
 */
export declare class VisibilityMetadata {
 ...
 * ```
 */
export declare class SelfMetadata extends VisibilityMetadata {
    constructor();
    toString(): string;
}
/**
 ...
 * ```
 */
export declare class AncestorMetadata extends VisibilityMetadata {
    constructor({self}?: {
        self?: boolean;
    });
    toString(): string;
 ...
 * ```
 */
export declare class UnboundedMetadata extends VisibilityMetadata {
    constructor({self}?: {
        self?: boolean;
    });
    toString(): string;
}
export declare const DEFAULT_VISIBILITY: VisibilityMetadata;
