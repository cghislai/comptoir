...
import { isBlank, isPresent, assertionsEnabled, print } from 'angular2/src/facade/lang';
import { Compiler, CompilerCache } from 'angular2/src/core/compiler/compiler';
import { Reflector, reflector } from 'angular2/src/reflection/reflection';
import { Parser, Lexer, ChangeDetection, DynamicChangeDetection, JitChangeDetection, Pipes, defaultPipes, PreGeneratedChangeDetection } from 'angular2/src/change_detection/change_detection';
...
export function bootstrapWebworkerCommon(appComponentType, bus, componentInjectableBindings = null) {
    ...
    zone.run(() => {
        ...
        //
        var listenerId;
        listenerId = bus.source.addListener((message) => {
