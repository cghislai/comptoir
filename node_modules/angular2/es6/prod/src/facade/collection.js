...
export class MapWrapper {
    ...
    static get(map, key) { return map.get(key); }
    static size(m) { return m.size; }
    static delete(m, k) { m.delete(k); }
    static clearValues(m) { _clearValues(m); }
    static iterable(m) { return m; }
    static keys(m) { return Array.from(m.keys()); }
    static values(m) { return Array.from(m.values()); }
}
/**
...
export class ListWrapper {
    ...
    static createGrowableSize(size) { return new List(size); }
