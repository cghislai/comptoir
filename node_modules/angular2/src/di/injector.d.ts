...
export declare class Injector {
    ...
    */
    ...
    _getByKeyAncestor(key: Key, optional: boolean, bindingVisibility: number, includeSelf: boolean): any;
    _getPrivateDependency(key: Key, optional: boolean, inj: Injector): any;
    _getByKeyUnbounded(key: Key, optional: boolean, bindingVisibility: number, includeSelf: boolean): any;
    displayName: string;
    toString(): string;
}
