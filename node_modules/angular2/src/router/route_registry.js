...
var RouteRegistry = (function () {
    ...
    RouteRegistry.prototype.config = function (parentComponent, config, isRootLevelRoute) {
        if (isRootLevelRoute === void 0) { isRootLevelRoute = false; }
    ...
    RouteRegistry.prototype.configFromComponent = function (component, isRootComponent) {
        var _this = this;
        if (isRootComponent === void 0) { isRootComponent = false; }
        ...
        if (lang_1.isPresent(annotations)) {
            for (var i = 0; i < annotations.length; i++) {
                ...
                if (annotation instanceof route_config_impl_1.RouteConfig) {
                    collection_1.ListWrapper.forEach(annotation.configs, function (config) { return _this.config(component, config, isRootComponent); });
                }
            }
        }
    };
