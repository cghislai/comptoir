...
export declare class AbstractBindingError extends BaseException {
    ...
    constructor(key: any, constructResolvingMessage: Function, originalException?: any, originalStack?: any);
    addKey(key: any): void;
    toString(): string;
}
/**
...
export declare class InstantiationError extends AbstractBindingError {
    causeKey: any;
    constructor(originalException: any, originalStack: any, key: any);
}
/**
