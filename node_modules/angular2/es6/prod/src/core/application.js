...
import { Parser, Lexer, ChangeDetection, DynamicChangeDetection, JitChangeDetection, PreGeneratedChangeDetection, Pipes, defaultPipes } from 'angular2/change_detection';
...
import { DomRenderer, DOCUMENT_TOKEN, DOM_REFLECT_PROPERTIES_AS_ATTRIBUTES } from 'angular2/src/render/dom/dom_renderer';
...
function _injectorBindings(appComponentType) {
    ...
    return [
        ...
        bind(LifeCycle)
            .toFactory((exceptionHandler) => new LifeCycle(exceptionHandler, null, assertionsEnabled()), [ExceptionHandler]),
        bind(EventManager)
            .toFactory((ngZone) => {
...
export function bootstrap(appComponentType, componentInjectableBindings = null, errorReporter = null) {
    ...
    zone.run(() => {
        ...
        var compRefToken = PromiseWrapper.wrap(() => appInjector.get(appComponentRefPromiseToken));
        ...
        PromiseWrapper.then(compRefToken, tick, (err, stackTrace) => bootstrapProcess.reject(err, stackTrace));
    });
