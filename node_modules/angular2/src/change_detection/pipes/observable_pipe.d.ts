 ...
 * ```
 */
export declare class ObservablePipe implements Pipe {
    ...
    onDestroy(): void;
    transform(obs: Observable, args?: List<any>): any;
 ...
 */
export declare class ObservablePipeFactory implements PipeFactory {
    supports(obs: any): boolean;
