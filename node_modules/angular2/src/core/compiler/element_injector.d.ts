...
import { Injector, ProtoInjector, Key, Dependency, Binding, ResolvedBinding, DependencyProvider } from 'angular2/di';
...
export declare class ElementInjector extends TreeNode<ElementInjector> implements DependencyProvider {
    ...
    private _addViewQueries(host);
    private _addViewQuery(queryRef);
