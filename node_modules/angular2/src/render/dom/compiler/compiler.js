...
var DomCompiler = (function (_super) {
    ...
    DomCompiler.prototype.compileHost = function (directiveMetadata) {
        ...
        return this._compileView(hostViewDef, new view_loader_1.TemplateAndStyles("<" + directiveMetadata.selector + "></" + directiveMetadata.selector + ">", []), api_1.ViewType.HOST);
    };
    ...
    DomCompiler.prototype._compileView = function (viewDef, templateAndStyles, protoViewType) {
        ...
        var compileElements = pipeline.processElements(dom_adapter_1.DOM.createTemplate(templateAndStyles.template), protoViewType, viewDef);
...
var DefaultDomCompiler = (function (_super) {
    ...
    function DefaultDomCompiler(parser, viewLoader, sharedStylesHost, appId) {
        _super.call(this, new compile_step_factory_1.DefaultStepFactory(parser, appId), viewLoader, sharedStylesHost);
    }
    DefaultDomCompiler = __decorate([
        di_1.Injectable(),
        __param(3, di_2.Inject(dom_tokens_1.APP_ID_TOKEN)), 
        __metadata('design:paramtypes', [change_detection_1.Parser, view_loader_1.ViewLoader, shared_styles_host_1.SharedStylesHost, Object])
    ], DefaultDomCompiler);
