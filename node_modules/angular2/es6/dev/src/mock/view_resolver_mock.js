...
import { isPresent, BaseException, stringify, isBlank } from 'angular2/src/facade/lang';
...
export class MockViewResolver extends ViewResolver {
    ...
    resolve(component) {
        ...
        if (isPresent(overrides) && isPresent(directives)) {
            ...
            view = new View({ template: view.template, templateUrl: view.templateUrl, directives: directives });
        }
