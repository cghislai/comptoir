...
import { DirectiveMetadata, ProtoViewDto, ViewDefinition, RenderProtoViewRef, RenderViewRef, RenderProtoViewMergeMapping, RenderFragmentRef } from 'angular2/src/render/api';
...
export let WorkerCompiler = class {
    ...
    compileHost(directiveMetadata) {
        var fnArgs = [new FnArg(directiveMetadata, DirectiveMetadata)];
...
export let WorkerRenderer = class {
    ...
    setElementClass(location, className, isAdd) {
        var fnArgs = [new FnArg(location, WorkerElementRef), new FnArg(className, null), new FnArg(isAdd, null)];
    ...
    invokeElementMethod(location, methodName, args) {
        var fnArgs = [new FnArg(location, WorkerElementRef), new FnArg(methodName, null), new FnArg(args, null)];
