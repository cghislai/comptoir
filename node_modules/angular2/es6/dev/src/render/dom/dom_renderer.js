...
export let DomRenderer = class extends Renderer {
    constructor(_eventManager, _domSharedStylesHost, document, reflectPropertiesAsAttributes) {
        super();
...
DomRenderer = __decorate([
    ...
    __param(3, Inject(DOM_REFLECT_PROPERTIES_AS_ATTRIBUTES)), 
    __metadata('design:paramtypes', [EventManager, DomSharedStylesHost, Object, Boolean])
], DomRenderer);
