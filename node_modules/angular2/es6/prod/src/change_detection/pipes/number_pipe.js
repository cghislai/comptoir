...
import { isNumber, isPresent, isBlank, NumberWrapper, RegExpWrapper, BaseException, CONST } from 'angular2/src/facade/lang';
import { NumberFormatter, NumberFormatStyle } from 'angular2/src/facade/intl';
import { ListWrapper } from 'angular2/src/facade/collection';
import { BasePipe } from './pipe';
var defaultLocale = 'en-US';
var _re = RegExpWrapper.create('^(\\d+)?\\.((\\d+)(\\-(\\d+))?)?$');
export let NumberPipe = class extends BasePipe {
    ...
    supports(obj) { return isNumber(obj); }
