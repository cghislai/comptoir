...
var RouteMatch = (function () {
    ...
    RouteMatch.prototype.params = function () {
        ...
        if (!this._paramsParsed) {
            ...
            collection_1.StringMapWrapper.forEach(this.recognizer.parseParams(this.matchedUrl), function (value, key) { collection_1.StringMapWrapper.set(_this._params, key, value); });
        }
        return this._params;
    };
    return RouteMatch;
