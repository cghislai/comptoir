...
var null_pipe_2 = require('./pipes/null_pipe');
exports.NullPipe = null_pipe_2.NullPipe;
exports.NullPipeFactory = null_pipe_2.NullPipeFactory;
/**
 ...
 */
exports.uppercase = lang_1.CONST_EXPR([lang_1.CONST_EXPR(new uppercase_pipe_1.UpperCasePipe()), lang_1.CONST_EXPR(new null_pipe_1.NullPipeFactory())]);
/**
 * Lowercase text transform.
 */
exports.lowercase = lang_1.CONST_EXPR([lang_1.CONST_EXPR(new lowercase_pipe_1.LowerCasePipe()), lang_1.CONST_EXPR(new null_pipe_1.NullPipeFactory())]);
/**
