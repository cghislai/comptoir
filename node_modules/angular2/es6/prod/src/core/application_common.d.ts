...
export declare function createNgZone(handler: ExceptionHandler): NgZone;
/**
 ...
 */
export declare function commonBootstrap(appComponentType: any, componentInjectableBindings?: List<Type | Binding | List<any>>): Promise<ApplicationRef>;
/**
