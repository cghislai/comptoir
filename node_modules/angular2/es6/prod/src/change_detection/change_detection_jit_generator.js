...
export class ChangeDetectorJITGenerator {
    constructor(id, changeDetectionStrategy, records, directiveRecords) {
        this.id = id;
    ...
    _genLocalDefinitions() { return this._localNames.map((n) => `var ${n};`).join("\n"); }
    _genChangeDefinitions() {
