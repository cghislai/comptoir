...
var Serializer = (function () {
    ...
    Serializer.prototype.serialize = function (obj, type) {
        ...
        else if (type == api_2.WorkerElementRef) {
    ...
    Serializer.prototype.objectToMap = function (obj, type, data) {
        ...
        if (lang_1.isPresent(type)) {
            ...
            collection_1.StringMapWrapper.forEach(obj, function (key, val) { map.set(key, _this.deserialize(val, type, data)); });
            return map;
        }
        else {
    ...
    Serializer.prototype._deserializeWorkerElementRef = function (map) {
        return new api_2.WorkerElementRef(this.deserialize(map['renderView'], api_1.RenderViewRef), map['renderBoundElementIndex']);
    };
    ...
    Serializer.prototype._serializeViewDefinition = function (view) {
        return {
            ...
            'directives': this.serialize(view.directives, api_1.DirectiveMetadata),
    ...
    Serializer.prototype._deserializeViewDefinition = function (obj) {
        return new api_1.ViewDefinition({
            ...
            directives: this.deserialize(obj['directives'], api_1.DirectiveMetadata),
    ...
    Serializer.prototype._serializeProtoViewDto = function (view) {
        return {
            ...
            'elementBinders': this.serialize(view.elementBinders, api_1.ElementBinder),
    ...
    Serializer.prototype._deserializeProtoViewDto = function (obj) {
        return new api_1.ProtoViewDto({
            ...
            elementBinders: this.deserialize(obj['elementBinders'], api_1.ElementBinder),
            variableBindings: this.objectToMap(obj['variableBindings']),
    ...
    Serializer = __decorate([
        di_1.Injectable(), 
        __metadata('design:paramtypes', [parser_1.Parser, render_proto_view_ref_store_1.RenderProtoViewRefStore, render_view_with_fragments_store_1.RenderViewWithFragmentsStore])
    ], Serializer);
    return Serializer;
})();
