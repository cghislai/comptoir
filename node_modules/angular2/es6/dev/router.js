...
export const routerDirectives = CONST_EXPR([RouterOutlet, RouterLink]);
export var routerInjectables = [
    ...
    Location,
    bind(Router)
        .toFactory((registry, pipeline, location, appRoot) => { return new RootRouter(registry, pipeline, location, appRoot); }, [RouteRegistry, Pipeline, Location, appComponentTypeToken])
];
