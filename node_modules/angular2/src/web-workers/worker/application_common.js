...
var application_1 = require('angular2/src/web-workers/worker/application');
var application_tokens_1 = require('angular2/src/core/application_tokens');
var application_2 = require('angular2/src/core/application');
...
function _injectorBindings(appComponentType, bus, initData) {
    ...
    return [
        di_1.bind(application_tokens_1.appComponentTypeToken)
        ...
        di_1.bind(appComponentType).toFactory(function (ref) { return ref.instance; }, [application_tokens_1.appComponentRefPromiseToken]),
        ...
        di_1.bind(application_1.WorkerMessageBus).toValue(bus),
        di_1.bind(broker_1.MessageBroker)
            .toFactory(function (a, b) { return new broker_1.MessageBroker(a, b); }, [application_1.WorkerMessageBus, serializer_1.Serializer]),
        renderer_1.WorkerRenderer,
        di_1.bind(api_1.Renderer).toAlias(renderer_1.WorkerRenderer),
        renderer_1.WorkerCompiler,
        di_1.bind(api_1.RenderCompiler).toAlias(renderer_1.WorkerCompiler),
        di_1.bind(api_2.ON_WEBWORKER).toValue(true),
...
function bootstrapWebworkerCommon(appComponentType, bus, componentInjectableBindings) {
    ...
    var zone = application_common_1.createNgZone(new exception_handler_1.ExceptionHandler(new PrintLogger()));
    zone.run(function () {
        ...
        listenerId = bus.source.addListener(function (message) {
            ...
            var compRefToken = async_1.PromiseWrapper.wrap(function () {
                try {
                    return appInjector.get(application_tokens_1.appComponentRefPromiseToken);
                }
                catch (e) {
                    throw e;
                }
            ...
            async_1.PromiseWrapper.catchError(compRefToken, function (err) {
                lang_1.print(err);
