...
export declare class CompileControl {
    ...
    _results: any[];
    _additionalChildren: CompileElement[];
    _ignoreCurrentElement: boolean;
    constructor(_steps: List<CompileStep>);
    internalProcess(results: any[], startStepIndex: number, parent: CompileElement, current: CompileElement): CompileElement[];
