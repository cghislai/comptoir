...
import { ViewContainerRef, TemplateRef, Pipes, LifecycleEvent, ChangeDetectorRef } from 'angular2/angular2';
...
export let NgFor = class {
    constructor(viewContainer, templateRef, pipes, cdr) {
...
NgFor = __decorate([
    ...
    __metadata('design:paramtypes', [ViewContainerRef, TemplateRef, Pipes, ChangeDetectorRef])
], NgFor);
